...
export class AddEditItemComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    this.size = new FormControl(this.item.size, [Validators.required]);
  ...
  onSave(): void {
    let item: Item = new Item(this.title.getRawValue()!, this.description.getRawValue()!, this.category.getRawValue()!, this.size.getRawValue()!,this.price.getRawValue()!, this.imageUrl.getRawValue()!);
    ...
    item.size=this.size.getRawValue()!;
